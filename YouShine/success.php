            ...
            <div class="container-fluid">
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="row">
                                ...
                                <div class="col-md-9">
                                    <h3 class="pt-5" style="color: #9c5451;">YouShine</h3>
                    ...
                    <div class="row">
                        ...
                        <label class="pl-5 pt-1" style="font-size: 20px; color: black;">Invoice to : </label><a class="pt-2" style="color: black;">&nbsp;&nbsp;The Palladium,Yogi Chowk, Surat, Gujarat 395006.</a>
                        ...
                        <div class="col-md-12"> 
                            <table style="font-family: arial, sans-serif; border-collapse: collapse; width: 100%;">
                                ...
                                <tr class="paple">
                                    ...
                                    <th style="background-color: #9c5451; color: white; border-color: white; font-weight:50">PACK AMOUNT</th>
