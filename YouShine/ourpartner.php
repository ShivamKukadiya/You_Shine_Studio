                ...
                <div class="blog-style">
                    ...
                    <div class="col-md-6">
                        <a href="designer_register.php">
                            <button type="btn" name="register" value="submit" class="butn-dark btn btn-block">As Designer Join</button>
                        </a>
                    </div>
                    </center>
                </div>
                    ...
                    <a class="blog-img" style="height: 300px;width:300px;background-color:tomato;border-radius:20px"><img src="img/kisspng.png" class="img-fluid" alt=""></a>
                        ...
                        <div class="col-md-6">
                            <a href="company_register.php">
                                <button  type="btn" name="register" value="submit" class="butn-dark btn btn-block">(Designer & Company)<br> Join Now</button>
                            </a>
                        </div>
