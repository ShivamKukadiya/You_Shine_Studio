                            ...
                            <div class="col-md-12 lp">
                                ...
                                <div class="row asd">
                                    ...
                                    <p class="col-md-5 ml-2 abc cba d-flex align-items-end">
                                        <a class="yas" href="<?php echo $row[9]; ?>" download="<?php echo rand(0,9)."_".chr(rand(97,122)).chr(rand(97,122)).chr(rand(97,122)).chr(rand(65,90)).rand(0,9).rand(0,9)." - YouShine"; ?>"><i class="ti-download"></i></a>
                                    </p>
                                </div>
                                        ...
                                        <div class="col-md-12 lp">
                                            ...
                                            <div class="row pino">
                                                ...
                                                <p class="col-md-5 ml-2 nir cba d-flex align-items-end">
                                                    ...
                                                    <a class="load" href="<?php echo $row[9]; ?>" download="<?php echo rand(0,9)."_".chr(rand(97,122)).chr(rand(97,122)).chr(rand(97,122)).chr(rand(65,90)).rand(0,9).rand(0,9)." - YouShine"; ?>"><i class="ti-download"></i></a>
