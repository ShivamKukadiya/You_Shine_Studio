                    ...
                    <form class="" action="" enctype="multipart/form-data" method="post" id="registrationform" novalidate name="registration" onsubmit="return checkpass();">
						<div class="row">
                            ...
                            <div class="col-md-12 m-0 mt-2" >
                                <input type="text" class="form-control-sm" id="" name="name" placeholder="Enter Company Name" required="">
                            ...
                            <div class="col-md-12 mt-2">
    							<input type="text" class="form-control-sm" id="" name="location" placeholder="Enter Location" required="">
    						</div>

                            <div class="col-md-12 mt-0">
    							<input type="text" class="form-control-sm" id="" name="contact" placeholder="Contact Number" required="">
    						</div>

							<div class="col-md-12 mt-2">
								<input type="text" class="form-control-sm" id="" name="since" placeholder="Company Starting Year" required="">
							</div>
    						...
    						<div class="form-group col-md-12">
    							...
    							<p class="text-center m-0 p-0 ifc"> Already a register!<a href="login.php" class="ia">Login Here </a></p>
    						</div>
                        </div>
					</form>
                </div>
