                                        ...
                                        <div class="col-md-12 lp">
                                            ...
                                            <div class="row pino">
                                                ...
                                                <p class="col-md-5 ml-2 nir cba d-flex align-items-end">
                                                    <a class="load" href="<?php echo $row[9]; ?>" download="<?php echo rand(0,9)."_".chr(rand(97,122)).chr(rand(97,122)).chr(rand(97,122)).chr(rand(65,90)).rand(0,9).rand(0,9)." - YouShine"; ?>" onclick="likepost('<?php echo $_SESSION['userid']; ?>','<?php echo $row[0]; ?>','<?php echo $row[1]; ?>','<?php echo $row[6]; ?>','index','download');"><i class="ti-download"></i></a>
                                                </p>
                                            </div>
